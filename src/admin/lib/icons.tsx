...
const ICONS: Record<string, string> = {
  // Brand mark: a bag of generated records. Stroked variant of assets/brand/fakerpress-mark.svg.
  logomark:
    '<path d="M4.8 8.4h14.4a1.2 1.2 0 0 1 1.2 1.3l-1 9a1.8 1.8 0 0 1-1.8 1.7H6.4a1.8 1.8 0 0 1-1.8-1.7l-1-9a1.2 1.2 0 0 1 1.2-1.3Z"/><path d="M8.8 8.4V6.8a3.2 3.2 0 0 1 6.4 0v1.6"/><path d="M7.2 12.2h9.2"/><path d="M7.2 15.6h6.8"/>',
