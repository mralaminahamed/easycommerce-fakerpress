...
export default function ProductVariationGenerator() {
  ...
  const parameterConfig = {
    specific_product_id: {
      description: __(
        "Specific product ID to generate variations for",
        "easycommerce-fakerpress",
      ),
      type: "integer",
      minimum: 1,
    ...
    product_types: {
      description: __(
        "Product types to consider for variation generation",
        "easycommerce-fakerpress",
      ),
      type: "array",
      items: {
    ...
    exclude_products: {
      description: __(
        "Product IDs to exclude from variation generation",
        "easycommerce-fakerpress",
      ),
      type: "array",
      items: {
    ...
    price_variance: {
      description: __(
        "Price variance settings for variations",
        "easycommerce-fakerpress",
      ),
      type: "object",
      properties: {
        min_percentage: {
          description: __(
            "Minimum price variance percentage from base product",
            "easycommerce-fakerpress",
          ),
          type: "number",
          minimum: -50,
        ...
        max_percentage: {
          description: __(
            "Maximum price variance percentage from base product",
            "easycommerce-fakerpress",
          ),
          type: "number",
          minimum: -50,
    ...
    stock_settings: {
      description: __(
        "Stock management settings for variations",
        "easycommerce-fakerpress",
      ),
      type: "object",
      properties: {
    ...
    variation_attributes: {
      ...
      properties: {
        ...
        max_attributes_per_variation: {
          description: __(
            "Maximum attributes per variation",
            "easycommerce-fakerpress",
          ),
          type: "integer",
          minimum: 1,
