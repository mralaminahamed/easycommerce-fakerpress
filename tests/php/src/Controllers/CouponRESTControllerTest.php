...
/**
 * Test class for Coupon REST Controller
 *
 * @covers \EasyCommerceFakerPress\Controllers\Coupon
 */
class CouponRESTControllerTest extends EasyCommerceFakerPressUnitTestCase {
	...
	public function test_route_registration(): void {
		...
		$this->assertArrayHasKey( '/easycommerce-fakerpress/v1/coupons/generate', $routes );
	}

	/**
	 * Test successful coupon generation
	 */
	public function test_successful_coupon_generation(): void {
		...
		$this->assertCount( 2, $data['coupons'] );
	}

	/**
	 * Test coupon generation with parameters
	 */
	public function test_coupon_generation_with_parameters(): void {
		wp_set_current_user( $this->admin_user_id );
