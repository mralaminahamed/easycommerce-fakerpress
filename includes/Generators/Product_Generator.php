...
class Product_Generator extends Generator {
	...
	protected function generate_single_item() {
		...
		try {
			...
			// Clean up the created post if meta insertion fails
	 ...
	 * @return void
	 */
	private function insertProductMeta( int $product_id ): void {
		$gallery_images = [];
	 ...
	 */
	private function createProductVariations( int $product_id ): array {
		$variations      = [];
	...
	private function insertVariationMeta( $variation_id ): void {
		$meta_entries = [
	...
	private function insertVariationAttributes( $variation_id ): void {
	...
	private function createDefaultAttributes(): void {
	 ...
	 * @return void
	 */
	private function assignTaxonomies( int $product_id ): void {
	...
	private function assignProductCategories( int $product_id ): void {
	...
	private function assignProductBrands( int $product_id ): void {
		$brands = get_terms( [
