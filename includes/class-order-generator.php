...
class ECFP_Order_Generator
{
    ...
    private function addOrderItems($order_id, $variations)
    {
    ...
    private function addOrderItemMeta($item_id, $variation)
    {
    ...
    private function addOrderMeta($order_id, $customer, $total)
    {
    ...
    private function getRandomCoupons()
    {
    ...
    private function updateCustomerStats($customer_id, $order_total)
    {
        // Get current stats
